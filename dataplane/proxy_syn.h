...
{
public:
    bool Initialize(proxy_service_id_t service_id, uint32_t number_syns, dataplane::memory_manager* memory_manager);
    bool _TestInit(proxy_service_id_t service_id, uint32_t number_syns);
    bool _TestFree();
