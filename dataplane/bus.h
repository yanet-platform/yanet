...
public:
	...
	static void FillMetadataBusCounters(common::sdp::MetadataBusCounters& metadata, uint64_t& size);
	void SetBufferForCounters(void* buffer, const common::sdp::MetadataBusCounters& metadata);
