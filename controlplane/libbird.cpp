...
static inline bool
recover_prefix_info(net_addr_union *paddr, common::ip_prefix_t *prefix,
		    common::ip_address_t *vpnDST, uint32_t *vpnRD)
{
...
static bool
parse_route_update(uintptr_t *ppos, uintptr_t end, const char *vrf,
		   common::icp::rib_update::action *paction)
{
	...
	while (*ppos < attrs_end) {
		...
		case BA_ORIGIN: {
			...
			switch (origin) {
			case 0: attribute_origin = "IGP"; break;
			case 1: attribute_origin = "EGP"; break;
			case 2: attribute_origin = "Incomplete"; break;
			default: attribute_origin = "?";
			}
