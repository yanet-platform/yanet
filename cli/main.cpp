...
std::vector<std::tuple<std::string,
        ...
        commands = {{"help", "", [](const auto& args) { Call(help, args); }},
                    ...
                    {"balancer lookup", "[module] <virtual_ip> <proto> <virtual_port>", [](const auto& args) { Call(balancer::lookup_inspect, args); }},
                    ...
                    {},
                    {"tcpdump", "<read|follow> <ring_tag> [path]", [](const auto& args) { Call(show::tcpdump, args); }},
                    {},
