...
std::vector<std::tuple<std::string,
        ...
        commands = {{"help", "", [](const auto& args) { call(help, args); }},
                    ...
                    {"route lookup", "[vrf] [ip_address]", [](const auto& args) { call(route::lookup, args); }},
                    {"route get", "[vrf] [ip_prefix]", [](const auto& args) { call(route::get, args); }},
                    {"route tunnel lookup", "[vrf] [ip_address]", [](const auto& args) { call(route::tunnel::lookup, args); }},
                    {"route tunnel get", "[vrf] [ip_prefix]", [](const auto& args) { call(route::tunnel::get, args); }},
