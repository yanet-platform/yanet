...
write_pcap("001-send.pcap",
           ...
           # 1.0.0.16/28 -> 200.0.10.1
           # 1.0.0.16/30 -> 200.0.20.2    - "200.0.20.2/32 -> 200.0.20.1:112"
...
write_pcap("001-expect.pcap",
           ...
           Ether(dst="00:00:00:22:22:22", src="00:11:22:33:44:55")/Dot1Q(vlan=200)/MPLS(label=112, ttl=255)/IP(dst="1.0.0.17", src="222.222.222.222", ttl=63)/TCP(),
