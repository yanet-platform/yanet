...
write_pcap("001-send.pcap",
           ...
           Ether(dst="00:11:22:33:44:55", src="00:00:00:00:00:02")/Dot1Q(vlan=200)/IP(dst="10.0.0.3", src="1.1.0.2", ttl=64)/UDP(dport=80, sport=12380),
           Ether(dst="00:11:22:33:44:55", src="00:00:00:00:00:02")/Dot1Q(vlan=200)/IP(dst="10.0.0.3", src="1.1.0.3", ttl=64)/UDP(dport=80, sport=12380),
           Ether(dst="00:11:22:33:44:55", src="00:00:00:00:00:02")/Dot1Q(vlan=200)/IP(dst="10.0.0.3", src="1.1.0.4", ttl=64)/UDP(dport=80, sport=12380))
...
write_pcap("001-expect.pcap",
           ...
           Ether(dst="00:00:00:00:00:01", src="00:11:22:33:44:55")/Dot1Q(vlan=100)/IPv6(dst="2000::4", src="2000:51b::0101:0002:0:1", hlim=63, fl=0)/IP(dst="10.0.0.3", src="1.1.0.2", ttl=64)/UDP(dport=80, sport=12380),
           Ether(dst="00:00:00:00:00:01", src="00:11:22:33:44:55")/Dot1Q(vlan=100)/IPv6(dst="2000::3", src="2000:51b::0101:0003:0:1", hlim=63, fl=0)/IP(dst="10.0.0.3", src="1.1.0.3", ttl=64)/UDP(dport=80, sport=12380),
           Ether(dst="00:00:00:00:00:01", src="00:11:22:33:44:55")/Dot1Q(vlan=100)/IPv6(dst="2000::4", src="2000:51b::0101:0004:0:1", hlim=63, fl=0)/IP(dst="10.0.0.3", src="1.1.0.4", ttl=64)/UDP(dport=80, sport=12380))
