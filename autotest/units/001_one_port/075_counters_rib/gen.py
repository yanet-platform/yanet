...
write_pcap("expect.pcap",
           Ether(dst="00:00:00:11:11:11", src="00:11:22:33:44:55")/Dot1Q(vlan=200)/MPLS(label=1100, ttl=0xff)/IP(dst="1.0.0.1", src="111.222.111.222", ttl=63)/TCP(),
           Ether(dst="00:00:00:11:11:11", src="00:11:22:33:44:55")/Dot1Q(vlan=200)/MPLS(label=1100, ttl=0xff)/IP(dst="1.0.0.2", src="111.222.111.222", ttl=63)/TCP(),
           Ether(dst="00:00:00:11:11:11", src="00:11:22:33:44:55")/Dot1Q(vlan=200)/MPLS(label=1100, ttl=0xff)/IP(dst="1.0.0.3", src="111.222.111.222", ttl=63)/TCP(),
           Ether(dst="00:00:00:11:11:22", src="00:11:22:33:44:55")/Dot1Q(vlan=300)/MPLS(label=1100, ttl=0xff)/IP(dst="2.0.0.4", src="111.222.111.222", ttl=63)/TCP(),
           Ether(dst="00:00:00:11:11:22", src="00:11:22:33:44:55")/Dot1Q(vlan=300)/MPLS(label=1100, ttl=0xff)/IP(dst="2.0.0.5", src="111.222.111.222", ttl=63)/TCP(),
           Ether(dst="00:00:00:11:11:22", src="00:11:22:33:44:55")/Dot1Q(vlan=300)/MPLS(label=1100, ttl=0xff)/IP(dst="3.0.0.6", src="111.222.111.222", ttl=63)/TCP(),
