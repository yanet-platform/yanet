...
write_pcap("001-send.pcap", [
    # Drop.
    ipv6_send("1111:2222::1", "2222:898:ff1c:2030::1", 200) / UDP(sport=(1024, 1040), dport=53),
    ipv6_send("1111:2222::1", "2222:898:ff1c:2030::1", 100) / UDP(sport=10001, dport=54),
    # Allow.
    ipv6_send("1111:2222::1", "2222:898:ff1c:2030::1", 200) / UDP(sport=10000, dport=54),
])

write_pcap("001-expect.pcap", [
    ipv6_recv("1111:2222::1", "2222:898:ff1c:2030::1") / UDP(sport=10000, dport=54),
])
