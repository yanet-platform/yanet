...
write_pcap("001-send.pcap", [
    ipv6_send("1111:2222::1", "2121:bbb8:ff1c:2030::1") / UDP(sport=1024, dport=53),
])

write_pcap("001-expect.pcap", [
    ipv6_recv("1111:2222::1", "2121:bbb8:ff1c:2030::1") / UDP(sport=1024, dport=53),

    Ether(src="00:11:22:33:44:55", dst="33:33:00:00:00:01") / Dot1Q(vlan=2000) / IPv6(src="fe80::f1", dst="ff02::1", hlim=64, fl=0) / UDP(sport=11995, dport=11995) / Raw(make_payload6("1111:2222::1", "2121:bbb8:ff1c:2030::1", 1024, 53)),
])

write_pcap("002-send.pcap", [
    # Mimic external multicast sync event.
    Ether(src="00:00:00:33:33:33", dst="33:33:00:00:00:01") / Dot1Q(vlan=2000) / IPv6(src="fe80::f2", dst="ff02::1", hlim=63, fl=0) / UDP(sport=11995, dport=11995) / Raw(make_payload6("1111:2222::10", "2121:bbb8:ff1c:2030::10", 10240, 530)),
])
...
write_pcap("003-send.pcap", [
    ipv6_send("2121:bbb8:ff1c:2030::10", "1111:2222::10") / UDP(sport=530, dport=10240),
])

write_pcap("003-expect.pcap", [
    ipv6_recv("2121:bbb8:ff1c:2030::10", "1111:2222::10") / UDP(sport=530, dport=10240),
])
