...
write_pcap("001-send.pcap", [
    ipv6_send("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=1024, dport=12345, flags="S"),
])

write_pcap("001-expect.pcap", [
    ipv6_recv("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=1024, dport=12345, flags="S"),

    Ether(src="00:11:22:33:44:55", dst="33:33:00:00:00:01") / Dot1Q(vlan=2000) / IPv6(src="fe80::f1", dst="ff02::1", hlim=64, fl=0) / UDP(sport=11995, dport=11995) / Raw(make_payload6(socket.IPPROTO_TCP, "1111:2222::1", "2a22:6b8:ff1c:2030::1", 1024, 12345, 2)),
])

write_pcap("002-send.pcap", [
    # Mimic external multicast sync event.
    Ether(src="00:00:00:33:33:33", dst="33:33:00:00:00:01") / Dot1Q(vlan=2000) / IPv6(src="fe80::f2", dst="ff02::1", hlim=63, fl=0) / UDP(sport=11995, dport=11995) / Raw(make_payload6(socket.IPPROTO_TCP, "1111:2222::10", "2a22:6b8:ff1c:2030::10", 10240, 54321, 2)),
])
...
write_pcap("003-send.pcap", [
    ipv6_send("2a22:6b8:ff1c:2030::10", "1111:2222::10") / TCP(sport=54321, dport=10240, flags="S"),
])

write_pcap("003-expect.pcap", [
    ipv6_recv("2a22:6b8:ff1c:2030::10", "1111:2222::10") / TCP(sport=54321, dport=10240, flags="S"),
])
...
write_pcap("007-send.pcap", [
    ipv6_send("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=777, dport=12345, flags="S"),
    ipv6_send("2a22:6b8:ff1c:2030::1", "1111:2222::1") / TCP(dport=777, sport=12345, flags="SA"),
    ipv6_send("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=777, dport=12345, flags="A"),
    ipv6_send("2a22:6b8:ff1c:2030::1", "1111:2222::1") / TCP(dport=777, sport=12345, flags="F"),
    ipv6_send("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=777, dport=12345, flags="FA"),
    ipv6_send("2a22:6b8:ff1c:2030::1", "1111:2222::1") / TCP(dport=777, sport=12345, flags="A"),
])

write_pcap("007-expect.pcap", [
    ipv6_recv("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=777, dport=12345, flags="S"),
    ipv6_recv("2a22:6b8:ff1c:2030::1", "1111:2222::1") / TCP(dport=777, sport=12345, flags="SA"),
    ipv6_recv("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=777, dport=12345, flags="A"),
    ipv6_recv("2a22:6b8:ff1c:2030::1", "1111:2222::1") / TCP(dport=777, sport=12345, flags="F"),
    ipv6_recv("1111:2222::1", "2a22:6b8:ff1c:2030::1") / TCP(sport=777, dport=12345, flags="FA"),
    ipv6_recv("2a22:6b8:ff1c:2030::1", "1111:2222::1") / TCP(dport=777, sport=12345, flags="A"),
