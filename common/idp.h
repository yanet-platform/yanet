...
enum class requestType : uint32_t
{
	...
	update_host_config,
        ringlog_state_update,
        worker_handler_stat_update
};
...
namespace ringlog_state_update
{
using request = std::tuple<bool, ///< enabled/disabled
                          uint32_t>; ///< value
}

namespace worker_handler_stat_update
{
using request = bool; ///< enabled/disabled
}
