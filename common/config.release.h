...
#define YANET_CONFIG_PROXIES_SIZE (32)
#define YANET_CONFIG_PROXY_SERVICES_SIZE (50000)

#ifdef SMALL_MEMORY_RELEASE

#undef YANET_CONFIG_DREGRESS_HT_SIZE
#define YANET_CONFIG_DREGRESS_HT_SIZE (8 * 128 * 1024)
#undef YANET_CONFIG_COUNTERS_SIZE
#define YANET_CONFIG_COUNTERS_SIZE (1 * 1024 * 1024)
#undef YANET_CONFIG_ROUTE_TUNNEL_WEIGHTS_SIZE
#define YANET_CONFIG_ROUTE_TUNNEL_WEIGHTS_SIZE (2 * 128 * 1024)
#undef YANET_CONFIG_BALANCER_SERVICES_SIZE
#define YANET_CONFIG_BALANCER_SERVICES_SIZE (2 * 128 * 1024)
#undef YANET_CONFIG_BALANCER_REALS_SIZE
#define YANET_CONFIG_BALANCER_REALS_SIZE (2 * 128 * 1024)
#undef YANET_CONFIG_BALANCER_WEIGHTS_SIZE
#define YANET_CONFIG_BALANCER_WEIGHTS_SIZE (32 * 128 * 1024)
#undef YANET_CONFIG_NAT64STATEFUL_HT_SIZE
#define YANET_CONFIG_NAT64STATEFUL_HT_SIZE (32 * 128 * 1024)
#undef YANET_CONFIG_DUMP_ID_TO_TAG_SIZE
#define YANET_CONFIG_DUMP_ID_TO_TAG_SIZE (128 * 1024)
