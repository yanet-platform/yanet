...
#define CONFIG_YADECAP_GB_ECMP_SIZE (31)
...
#define YANET_CONFIG_ROUTE_TUNNEL_WEIGHTS_SIZE (16 * 1024 * 1024)
...
#define YANET_CONFIG_BALANCER_WEIGHTS_SIZE (YANET_CONFIG_BALANCER_REALS_SIZE * YANET_CONFIG_BALANCER_REAL_WEIGHT_MAX)
