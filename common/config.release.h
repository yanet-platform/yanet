...
static constexpr std::uint32_t YANET_CONFIG_BALANCER_REAL_WEIGHT_MAX = 100;
static constexpr auto YANET_CONFIG_BALANCER_CELLS_PER_WEIGHT_UNIT = 40;
static constexpr std::uint32_t YANET_CONFIG_BALANCER_REAL_CELLS_MAX =
        YANET_CONFIG_BALANCER_CELLS_PER_WEIGHT_UNIT * YANET_CONFIG_BALANCER_REAL_WEIGHT_MAX;
static constexpr auto YANET_DEFAULT_BALANCER_REAL_MAPPINGS_LIMIT = 100;
#ifndef YANET_CONFIG_BALANCER_REALS_SIZE
#define YANET_CONFIG_BALANCER_REALS_SIZE (128 * 1024)
#endif
static constexpr std::uint32_t YANET_BALANCER_WRR_SERVICE_SIZE = YANET_CONFIG_BALANCER_REAL_WEIGHT_MAX * 10000;
#define YANET_CONFIG_BALANCER_SERVICES_SIZE (2 * 1024 * 1024)
#define YANET_CONFIG_BALANCER_WEIGHTS_SIZE (YANET_CONFIG_BALANCER_REALS_SIZE * YANET_CONFIG_BALANCER_REAL_CELLS_MAX)
