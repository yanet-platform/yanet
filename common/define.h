...
#define TCP_OPTIONS_MAX_SACK_COUNT (4)
...
#define YANET_PROXY_DEFAULT_CONNECTION_LIMIT_TIMEOUT ((uint32_t)(300))
#define YANET_PROXY_SIZE_RTE_PROXY_RETRANSMITS ((uint32_t)65536)
#define YANET_PROXY_MAX_RETRANSMITS_PER_CYCLE ((uint32_t)1024)
