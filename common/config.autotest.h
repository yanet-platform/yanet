...
#define YANET_CONFIG_ACL_NETWORK_LPM4_EXTENDED_CHUNKS_SIZE (256)

#undef YANET_CONFIG_ACL_NETWORK_DESTINATION_HT_SIZE
#define YANET_CONFIG_ACL_NETWORK_DESTINATION_HT_SIZE (2 * 1024)

#undef YANET_CONFIG_ACL_NETWORK_LPM6_TYPE
...
#define YANET_CONFIG_ACL_NETWORK_SOURCE_LPM6_CHUNKS_SIZE (256 * 128)

#undef YANET_CONFIG_ACL_NETWORK_DESTINATION_LPM6_CHUNKS_SIZE
#define YANET_CONFIG_ACL_NETWORK_DESTINATION_LPM6_CHUNKS_SIZE (256 * 128)

#undef YANET_CONFIG_ACL_NETWORK_TABLE_SIZE
#define YANET_CONFIG_ACL_NETWORK_TABLE_SIZE (16 * 1024)

#undef YANET_CONFIG_ACL_TRANSPORT_LAYERS_SIZE
#define YANET_CONFIG_ACL_TRANSPORT_LAYERS_SIZE (4)

#undef YANET_CONFIG_ACL_TRANSPORT_HT_SIZE
#define YANET_CONFIG_ACL_TRANSPORT_HT_SIZE (8 * 1024)

#undef YANET_CONFIG_ACL_TOTAL_HT_SIZE
#define YANET_CONFIG_ACL_TOTAL_HT_SIZE (64 * 1024)

#undef YANET_CONFIG_ACL_VALUES_SIZE
#define YANET_CONFIG_ACL_VALUES_SIZE (32 * 1024)
...
#define YANET_CONFIG_ACL_TREE_CHUNKS_BUCKET_SIZE (16)
