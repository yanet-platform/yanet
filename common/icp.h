...
namespace common { namespace icp
{
...
inline const char* requestType_toString(requestType t)
{
	switch (t)
	{
	case requestType::telegraf_unsafe: return "telegraf_unsafe";
	case requestType::telegraf_dregress: return "telegraf_dregress";
	case requestType::telegraf_dregress_traffic: return "telegraf_dregress_traffic";
	case requestType::telegraf_balancer_service: return "telegraf_balancer_service";
	case requestType::telegraf_other: return "telegraf_other";
	case requestType::telegraf_mappings: return "telegraf_mappings";
	case requestType::getPhysicalPorts: return "getPhysicalPorts";
	case requestType::getLogicalPorts: return "getLogicalPorts";
	case requestType::getDecaps: return "getDecaps";
	case requestType::getDecapPrefixes: return "getDecapPrefixes";
	case requestType::nat64stateful_config: return "nat64stateful_config";
	case requestType::nat64stateful_announce: return "nat64stateful_announce";
	case requestType::getNat64statelesses: return "getNat64statelesses";
	case requestType::getNat64statelessTranslations: return "getNat64statelessTranslations";
	case requestType::getNat64statelessPrefixes: return "getNat64statelessPrefixes";
	case requestType::route_config: return "route_config";
	case requestType::route_summary: return "route_summary";
	case requestType::route_interface: return "route_interface";
	case requestType::dregress_config: return "dregress_config";
	case requestType::balancer_config: return "balancer_config";
	case requestType::balancer_summary: return "balancer_summary";
	case requestType::balancer_service: return "balancer_service";
	case requestType::balancer_real_find: return "balancer_real_find";
	case requestType::balancer_real: return "balancer_real";
	case requestType::balancer_real_flush: return "balancer_real_flush";
	case requestType::balancer_announce: return "balancer_announce";
	case requestType::route_lookup: return "route_lookup";
	case requestType::route_get: return "route_get";
	case requestType::route_tunnel_lookup: return "route_tunnel_lookup";
	case requestType::route_tunnel_get: return "route_tunnel_get";
	case requestType::getRibStats: return "getRibStats";
	case requestType::checkRibPrefixes: return "checkRibPrefixes";
	case requestType::getDefenders: return "getDefenders";
	case requestType::getPortStatsEx: return "getPortStatsEx";
	case requestType::rib_update: return "rib_update";
	case requestType::rib_flush: return "rib_flush";
	case requestType::rib_summary: return "rib_summary";
	case requestType::rib_prefixes: return "rib_prefixes";
	case requestType::rib_lookup: return "rib_lookup";
	case requestType::rib_get: return "rib_get";
	case requestType::rib_save: return "rib_save";
	case requestType::rib_load: return "rib_load";
	case requestType::getFwList: return "getFwList";
	case requestType::limit_summary: return "limit_summary";
	case requestType::controlplane_values: return "controlplane_values";
	case requestType::loadConfig: return "loadConfig";
	case requestType::acl_unwind: return "acl_unwind";
	case requestType::acl_lookup: return "acl_lookup";
	case requestType::clearFWState: return "clearFWState";
	case requestType::getSamples: return "getSamples";
	case requestType::getAclConfig: return "getAclConfig";
	case requestType::tun64_tunnels: return "tun64_tunnels";
	case requestType::tun64_prefixes: return "tun64_prefixes";
	case requestType::tun64_mappings: return "tun64_mappings";
	case requestType::resolve_ip_to_fqdn: return "resolve_ip_to_fqdn";
	case requestType::resolve_fqdn_to_ip: return "resolve_fqdn_to_ip";
	case requestType::controlplane_durations: return "controlplane_durations";
	case requestType::version: return "version";
	case requestType::getFwLabels: return "getFwLabels";
	case requestType::size: return "unknown";
	}
...
namespace getFwList
{
	...
	inline const char* requestType_toString(requestType t)
	{
		switch (t)
		{
		case requestType::static_rules_original: return "static_rules_original";
		case requestType::static_rules_generated: return "static_rules_generated";
		case requestType::dynamic_states: return "dynamic_states";
		case requestType::dispatcher_rules: return "dispatcher_rules";
		};
	}
